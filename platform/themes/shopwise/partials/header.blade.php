...
<html lang="{{ app()->getLocale() }}">
    ...
    <header class="header_wrap @if (theme_option('enable_sticky_header', 'yes') == 'yes') fixed-top header_with_topbar @endif">
                ...
                <div class="nav_block">
                    ...
                    @if (theme_option('hotline'))
                        ...
                        <div class="contact_phone order-md-last">
                            ...
                            <span><a href="https://api.whatsapp.com/send?phone=905319848138">WhatSapp</a></span>
                        </div>
                    @endif
                    @if (is_plugin_active('ecommerce'))
                        <div class="product_search_form">
                            <form action="{{ route('public.products') }}" method="GET">
                                <div class="input-group">
                                    ...
                                    <input class="form-control" name="q" value="{{ BaseHelper::stringify(request()->query('q')) }}" placeholder="{{ __('Search Product') }}..." required  type="text">
        ...
        <div class="bottom_header light_skin main_menu_uppercase bg_dark @if (url()->current() === route('public.index')) mb-4 @endif">
            <div class="container">
                <div class="row">
                        ...
                        @if (is_plugin_active('ecommerce'))
                            <div class="categories_wrap">
                                <button type="button" data-toggle="collapse" data-target="#navCatContent" aria-expanded="false" class="categories_btn">
                                    ...
                                    <div id="navCatContent" class="@if (url()->current() === route('public.index') && theme_option('collapsing_product_categories_on_homepage', 'no') == 'no') nav_cat @endif navbar collapse">
